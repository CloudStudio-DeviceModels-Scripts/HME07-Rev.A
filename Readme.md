...
# Parsing + Configuration Script – HME07 - Rev. A

This **Parsing + Configuration** script is designed for the **HME07** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – HME07 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **HME07** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
